{ callPackage }:
{
  ...
  casual = callPackage (
    ...
    elpaBuild {
      ...
      version = "2.16.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/casual-2.16.1.tar";
        sha256 = "16l5v4vxymcrymhjhcabvh2yqn7fwjqhphdvjs9644v6vp2sfvsf";
      };
      packageRequires = [
        csv-mode
        transient
  ...
  simple-httpd = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.5.1";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/simple-httpd-1.5.1.tar";
        sha256 = "1aq8nz7y2q14w7mjm53ava6sd4pyksbj0hq8sdyy3hwgq1hzrrh5";
      };
      packageRequires = [ cl-lib ];
      meta = {
