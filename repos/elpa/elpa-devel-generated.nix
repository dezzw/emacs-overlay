{ callPackage }:
{
  ...
  auth-source-xoauth2-plugin = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.4.0.20260515.203435";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/auth-source-xoauth2-plugin-0.4.0.20260515.203435.tar";
        sha256 = "0j4gzg6hgdi9dz3h0i21pgnn7winzm2jp4sk3hb2m3bfnjy062x3";
      };
  ...
  company = callPackage (
    ...
    elpaBuild {
      pname = "company";
      ename = "company";
      version = "1.0.2.0.20260515.134946";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/company-1.0.2.0.20260515.134946.tar";
        sha256 = "1fwg2mq0arid394gnfpjwp26v0n7mshr928pyzi3pxsc4r6p026l";
      };
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.1.3.0.20260513.81245";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.1.3.0.20260513.81245.tar";
        sha256 = "0wf027nkmrigvnyk5bm0sx96lbwbpyxl5scv1s58s8q9qfnk2bpy";
      };
      packageRequires = [ ];
      meta = {
  ...
  dired-preview = callPackage (
    ...
    elpaBuild {
      pname = "dired-preview";
      ename = "dired-preview";
      version = "0.6.0.0.20260517.71603";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dired-preview-0.6.0.0.20260517.71603.tar";
        sha256 = "0sc3csdagkjmss7m2658amq7j6jsz4rlgxk3d8g3p7d5lqmcvri8";
      };
      packageRequires = [ ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "2.1.0.0.20260513.95422";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-2.1.0.0.20260513.95422.tar";
        sha256 = "07f9mi03ijg1bpqjsqigkypd8klawrbdlmvzlg1awiihsdkqrlcc";
      };
  ...
  forgejo = callPackage (
    ...
    elpaBuild {
      pname = "forgejo";
      ename = "forgejo";
      version = "0.2.1.0.20260516.60209";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/forgejo-0.2.1.0.20260516.60209.tar";
        sha256 = "0bhvp0y2jfxahna6q36lr6g8zb4zal86vyvk1yzck5m24prqnqik";
      };
  ...
  hyperbole = callPackage (
    ...
    elpaBuild {
      pname = "hyperbole";
      ename = "hyperbole";
      version = "9.0.2pre0.20260516.175416";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hyperbole-9.0.2pre0.20260516.175416.tar";
        sha256 = "1g9y7p155sglargq56x1mvq52i7indjblfdjgl5j9vbmqar3wqk1";
      };
      packageRequires = [ ];
      meta = {
  ...
  jinx = callPackage (
    ...
    elpaBuild {
      pname = "jinx";
      ename = "jinx";
      version = "2.7.0.20260508.232151";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jinx-2.7.0.20260508.232151.tar";
        sha256 = "135rmxcwpxqja8dzmw046pkfzk07y91908bfgpcp1xl3s6wwrg2v";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  minuet = callPackage (
    ...
    elpaBuild {
      pname = "minuet";
      ename = "minuet";
      version = "0.7.1.0.20260516.15637";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/minuet-0.7.1.0.20260516.15637.tar";
        sha256 = "16y6dhzmsqhlcbcizhq3r0anv4f85mn07djcic1z7nn24zjyi772";
      };
      packageRequires = [
        dash
        plz
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "10.0pre0.20260517.62534";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-10.0pre0.20260517.62534.tar";
        sha256 = "1ipqnzppmpihbkb6kr6pfsygyxli7d76f3w6idy7z0a6bbv1bsyk";
      };
      packageRequires = [ ];
      meta = {
  ...
  tmr = callPackage (
    ...
    elpaBuild {
      pname = "tmr";
      ename = "tmr";
      version = "1.3.0.0.20260515.111850";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/tmr-1.3.0.0.20260515.111850.tar";
        sha256 = "1127h8s1x2ppnwl2l6ygvrqfb2s8vczi122ikdfjnpk5xqrv10c3";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.13.3.0.20260516.215315";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.13.3.0.20260516.215315.tar";
        sha256 = "0b5rwcb57j2kiy4vm07pv68hkicgkl55g3mi9f3ivgc56l6fdrkb";
      };
      packageRequires = [
        compat
        cond-let
