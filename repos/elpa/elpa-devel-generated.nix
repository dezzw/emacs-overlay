{ callPackage }:
{
  ...
  beframe = callPackage (
    ...
    elpaBuild {
      pname = "beframe";
      ename = "beframe";
      version = "1.5.0.0.20260827.16";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/beframe-1.5.0.0.20260827.16.tar";
        sha256 = "1dzzd0s9kmfi4hsfimzjcpqbj9h91k86hd6j56fcmqjdx7hbbjbp";
      };
      packageRequires = [ ];
      meta = {
  ...
  compat = callPackage (
    ...
    elpaBuild {
      pname = "compat";
      ename = "compat";
      version = "31.0.0.2.0.20260824.6";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/compat-31.0.0.2.0.20260824.6.tar";
        sha256 = "12rm30yrsvz0cpwcaag15nys55d3kny1pbrkc5k5hb2x35lvf0ll";
      };
      packageRequires = [ ];
      meta = {
  ...
  debbugs = callPackage (
    ...
    elpaBuild {
      pname = "debbugs";
      ename = "debbugs";
      version = "0.47.0.20260824.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/debbugs-0.47.0.20260824.4.tar";
        sha256 = "1lgicrysj0dhymnlyffdkvi2jndyxbmj31mxs4v18prmp0zhcfcs";
      };
  ...
  denote = callPackage (
    ...
    elpaBuild {
      pname = "denote";
      ename = "denote";
      version = "4.2.3.0.20260827.23";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/denote-4.2.3.0.20260827.23.tar";
        sha256 = "0j5w8ij8ndg66560zi93m09jw4jwpidpgxddrjdbqjgiil1zdlgm";
      };
      packageRequires = [ ];
      meta = {
  ...
  dicom = callPackage (
    ...
    elpaBuild {
      pname = "dicom";
      ename = "dicom";
      version = "1.6.0.20260821.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dicom-1.6.0.20260821.0.tar";
        sha256 = "1sicw18rpym8v8d65nwfp52dphj73absb6gvx1nlz5zp1zmqy2b4";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  ef-themes = callPackage (
    ...
    elpaBuild {
      pname = "ef-themes";
      ename = "ef-themes";
      version = "2.2.1.0.20260814.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ef-themes-2.2.1.0.20260814.0.tar";
        sha256 = "055g6fci2afg9v6crc8sw1s3cx7c87dhy240z7286w1nzcn2m6wz";
      };
  ...
  flymake-harper = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.1.0.20260821.0";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/flymake-harper-0.1.1.0.20260821.0.tar";
        sha256 = "071f6a648hg2zyrgj02l0igf20ms8v9ahsmra9g63vlrzmzhy9c0";
      };
      packageRequires = [ ];
      meta = {
  ...
  futur = callPackage (
    ...
    elpaBuild {
      pname = "futur";
      ename = "futur";
      version = "2.0.0.20260822.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/futur-2.0.0.20260822.4.tar";
        sha256 = "1v1gamlig0flcj7chya18nv3vy9iyrph8gr53l6l5i5sf78xdi6h";
      };
      packageRequires = [ ];
      meta = {
  ...
  kubed = callPackage (
    ...
    elpaBuild {
      pname = "kubed";
      ename = "kubed";
      version = "0.7.1.0.20260817.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/kubed-0.7.1.0.20260817.4.tar";
        sha256 = "080f0xymw8qhmw396089mcqmrpac44qx95ac5m8rcq1y4d0lk2yy";
      };
      packageRequires = [ ];
      meta = {
  ...
  orderless = callPackage (
    ...
    elpaBuild {
      pname = "orderless";
      ename = "orderless";
      version = "1.7.0.20260811.5";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/orderless-1.7.0.20260811.5.tar";
        sha256 = "1x89w43g3vi96w68j95v46nd0vcidzx17vjy12wli9b7whyvcsbx";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  org = callPackage (
    ...
    elpaBuild {
      pname = "org";
      ename = "org";
      version = "10.0pre0.20260824.523";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/org-10.0pre0.20260824.523.tar";
        sha256 = "0w9p38j4mm1p3y2163i0554hxf05vnj4k7vin5h9i0756nkk51p8";
      };
      packageRequires = [ ];
      meta = {
  ...
  osm = callPackage (
    ...
    elpaBuild {
      pname = "osm";
      ename = "osm";
      version = "2.5.0.20260811.2";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/osm-2.5.0.20260811.2.tar";
        sha256 = "02fpfdla0ywilwl13jff8ga3mmkngf5dxf0s84nw13jcdcafh47k";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  parser-generator = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.2.9.0.20260817.2";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/parser-generator-0.2.9.0.20260817.2.tar";
        sha256 = "1y2bwvvml4za0gl71pljgcaamkcqw6bqywc29midl5pmifs8fkik";
      };
      packageRequires = [ ];
      meta = {
  ...
  realgud = callPackage (
    ...
    elpaBuild {
      pname = "realgud";
      ename = "realgud";
      version = "1.6.0.0.20260821.16";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/realgud-1.6.0.0.20260821.16.tar";
        sha256 = "189x6bia0faz3n53d7j6cqzh8czpq6x0g34v94qm8p09psk1apyc";
      };
      packageRequires = [
        load-relative
        loc-changes
  ...
  ssh-deploy = callPackage (
    ...
    elpaBuild {
      pname = "ssh-deploy";
      ename = "ssh-deploy";
      version = "3.1.16.0.20260817.4";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/ssh-deploy-3.1.16.0.20260817.4.tar";
        sha256 = "1jhjh26hnighz9wlfb6yrwmn4hf9jln93vyhq31m3m9wdbmksqq2";
      };
      packageRequires = [ ];
      meta = {
