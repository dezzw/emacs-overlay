{ callPackage }:
{
  ...
  treeview = callPackage (
    ...
    elpaBuild {
      pname = "treeview";
      ename = "treeview";
      version = "1.4.0.0.20260926.3";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/treeview-1.4.0.0.20260926.3.tar";
        sha256 = "1zffw4hh4bylqv7bs1n12f1nxrdpz2fipyb208n5gdca07j8mp8r";
      };
      packageRequires = [ ];
      meta = {
