{ callPackage }:
{
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "1.1.1.0.20260511.171025";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-1.1.1.0.20260511.171025.tar";
        sha256 = "1r4n2969rgj885aijfx6arxwqdjjksmwy50wnm6r8zaqy1zj2fx7";
      };
      packageRequires = [ ];
      meta = {
  ...
  elfeed-web = callPackage (
    ...
    elpaBuild {
      pname = "elfeed-web";
      ename = "elfeed-web";
      version = "3.4.2.0.20260511.124453";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-web-3.4.2.0.20260511.124453.tar";
        sha256 = "032jyivazcr82al1p5qqk9c5rxssc9yrfvbbf5g6wwxh7ff2fssx";
      };
      packageRequires = [
        compat
        elfeed
  ...
  gnuplot = callPackage (
    ...
    elpaBuild {
      pname = "gnuplot";
      ename = "gnuplot";
      version = "0.11.0.20260506.194622";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnuplot-0.11.0.20260506.194622.tar";
        sha256 = "0w1fcpf9p5l6lzjj6pmd3hcgcjflrbhpxgmriibd2dxjbc72xkar";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.10.0snapshot0.20260429.111805";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.10.0snapshot0.20260429.111805.tar";
        sha256 = "1r2wcjwspsryszjra34ha4n0p0in0bia6a18n47lcka7mxdkmw48";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  scad-mode = callPackage (
    ...
    elpaBuild {
      pname = "scad-mode";
      ename = "scad-mode";
      version = "98.0.0.20260502.95437";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/scad-mode-98.0.0.20260502.95437.tar";
        sha256 = "191kc4hyz30fqhaxhs10785ggpjl7rz2vhyabg3xxlwz9qi3kk6h";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.5.0.0.20260506.71738";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.5.0.0.20260506.71738.tar";
        sha256 = "1ljmbjy83c1rzv7vp9qbix5nq6pj22lfr4arx7kyapj5lw2rbk02";
      };
      packageRequires = [ compat ];
      meta = {
