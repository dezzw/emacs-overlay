{ callPackage }:
{
  ...
  codex-ide = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.1.3";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/codex-ide-0.1.3.tar";
        sha256 = "104lgsm224d25rmxi79rf6z7w47c0x3224gyyxmyib2zsd8cp01a";
      };
      packageRequires = [
        compat
        eat
  ...
  fj = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.45";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/fj-0.45.tar";
        sha256 = "18rfznyaxgz2qm3l74cx04liwy7k40nwgill6b16s7i0ivy4b2i7";
      };
      packageRequires = [
        compat
        fedi
  ...
  hermes = callPackage (
    ...
    elpaBuild {
      ...
      version = "0.7.0";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu/hermes-0.7.0.tar";
        sha256 = "0g2rqq1r1np0z1f0kqqfnrnixq729v84gq0frhc6d3rmrp6lv0z1";
      };
      packageRequires = [
        keymap-popup
        markdown-mode
