{ callPackage }:
{
  ...
  casual = callPackage (
    ...
    elpaBuild {
      pname = "casual";
      ename = "casual";
      version = "2.16.1.0.20260512.114240";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/casual-2.16.1.0.20260512.114240.tar";
        sha256 = "0n85i32pvqn2qna9b155zzhaa6fwdy3xp7r3xq5vhkkvxbzki4iv";
      };
      packageRequires = [
        csv-mode
        transient
  ...
  cond-let = callPackage (
    ...
    elpaBuild {
      pname = "cond-let";
      ename = "cond-let";
      version = "1.1.1.0.20260517.221751";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/cond-let-1.1.1.0.20260517.221751.tar";
        sha256 = "1zm1qmvj1lqn49rlnqqlf9h940sjr4ka20nyzi394z514847jh20";
      };
      packageRequires = [ ];
      meta = {
  ...
  consult-flycheck = callPackage (
    ...
    elpaBuild {
      ...
      version = "1.1.0.20260517.211429";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/consult-flycheck-1.1.0.20260517.211429.tar";
        sha256 = "05rlzz3z5ykgyjjbpxn94fk658ypjr587g4iiafdwin2rx2b42nx";
      };
      packageRequires = [
        consult
        flycheck
  ...
  elfeed = callPackage (
    ...
    elpaBuild {
      pname = "elfeed";
      ename = "elfeed";
      version = "3.4.2.0.20260526.464";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-3.4.2.0.20260526.464.tar";
        sha256 = "0v3fxm6k0y068a2srwsb9sq6z8r03bkka3d280bd81h4d5nq5crj";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  elfeed-web = callPackage (
    ...
    elpaBuild {
      pname = "elfeed-web";
      ename = "elfeed-web";
      version = "3.4.2.0.20260519.210114";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/elfeed-web-3.4.2.0.20260519.210114.tar";
        sha256 = "1r1fl8sj37h05npcyb4zrvnb063340g9pvx02v9ba28wlciai4kj";
      };
      packageRequires = [
        compat
        elfeed
  ...
  gnuplot = callPackage (
    ...
    elpaBuild {
      pname = "gnuplot";
      ename = "gnuplot";
      version = "0.12.0.20260523.142122";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gnuplot-0.12.0.20260523.142122.tar";
        sha256 = "0rx00dkw8g2z67ax69pywr342awh3dv0scyb7ry002f78spiswya";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  helm = callPackage (
    ...
    elpaBuild {
      pname = "helm";
      ename = "helm";
      version = "4.0.7.0.20260526.8";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-4.0.7.0.20260526.8.tar";
        sha256 = "0cyhmmiv0jssqpv5pmrfi19a71llnmy7z9ihlyisjpv9b8yzqasp";
      };
      packageRequires = [
        helm-core
        wfnames
  ...
  helm-core = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.0.7.0.20260526.8";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/helm-core-4.0.7.0.20260526.8.tar";
        sha256 = "15k82xcm28yg4xby92539ywd8c0yhm29c09nwg3wh5k7v0dznaip";
      };
  ...
  jabber = callPackage (
    ...
    elpaBuild {
      pname = "jabber";
      ename = "jabber";
      version = "0.10.9.0.20260526.10";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/jabber-0.10.9.0.20260526.10.tar";
        sha256 = "13hgss7f453aly9ssi6rjr1k34kwaqm3fcham9baxyp9r02pn03p";
      };
      packageRequires = [
        fsm
        keymap-popup
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260520.204514";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260520.204514.tar";
        sha256 = "1y54wvdjg6f92kkn3wrkm9pdlj487zj4l94039cqlavfdlnpr9k2";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260520.204514";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260520.204514.tar";
        sha256 = "08k9jjrs8dn9ynn5li5plbs2m0zs3hz20gp3ywfrb8q2bl312hlc";
      };
      packageRequires = [
        compat
        cond-let
  ...
  orgit = callPackage (
    ...
    elpaBuild {
      pname = "orgit";
      ename = "orgit";
      version = "2.1.2.0.20260511.143907";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/orgit-2.1.2.0.20260511.143907.tar";
        sha256 = "0d6wg84bd6rzbvmzpw944q8gvs4zf943r12lcj5fkybrmwslfzqg";
      };
      packageRequires = [
        compat
        cond-let
  ...
  sesman = callPackage (
    ...
    elpaBuild {
      pname = "sesman";
      ename = "sesman";
      version = "0.3.30.20240417.172323";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/sesman-0.3.30.20240417.172323.tar";
        sha256 = "0mh2xyy3h7bj36s4vvgjqd1fyaw0j281mcd9z14vc3rjvd7blmz7";
      };
      packageRequires = [ ];
      meta = {
  ...
  simple-httpd = callPackage (
    ...
    elpaBuild {
      pname = "simple-httpd";
      ename = "simple-httpd";
      version = "1.6.0.20260519.102820";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/simple-httpd-1.6.0.20260519.102820.tar";
        sha256 = "10s9jhpj6y9yfbifg3099980maikvky13p3n5nmhqnn4zqifq38m";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  tuareg = callPackage (
    ...
    elpaBuild {
      pname = "tuareg";
      ename = "tuareg";
      version = "3.0.20.20250910.140516";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/tuareg-3.0.20.20250910.140516.tar";
        sha256 = "0fh00nz9zb4hxqj4hg6w08qn5lmzj79965la48jpdlm1jxf5f8zc";
      };
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.5.0.0.20260518.94821";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.5.0.0.20260518.94821.tar";
        sha256 = "1s0f55xv115cjia96977g0l3amkcf195p57zl4zawl3q60xby5v9";
      };
      packageRequires = [
        compat
        cond-let
