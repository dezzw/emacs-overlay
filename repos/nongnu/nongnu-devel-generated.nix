{ callPackage }:
{
  ...
  gptel = callPackage (
    ...
    elpaBuild {
      pname = "gptel";
      ename = "gptel";
      version = "0.9.9.5.0.20260628.46";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/gptel-0.9.9.5.0.20260628.46.tar";
        sha256 = "0a24zm6rmab2rdgg96lx8r7jpa0gz0aksgqjn0jb32a8ljzv0g9f";
      };
      packageRequires = [
        compat
        transient
  ...
  magit = callPackage (
    ...
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "4.5.0.0.20260630.312";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-4.5.0.0.20260630.312.tar";
        sha256 = "0ksnagknaizzw3isiyglql7w1jz1klb31yxkmz79r2bp4ifnzph7";
      };
      packageRequires = [
        compat
        cond-let
  ...
  magit-section = callPackage (
    ...
    elpaBuild {
      ...
      version = "4.5.0.0.20260630.312";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/magit-section-4.5.0.0.20260630.312.tar";
        sha256 = "16igilm1p6742jwap12jwf16k6avzcbdh73s2i2p6bbmcyavjb8l";
      };
      packageRequires = [
        compat
        cond-let
  ...
  vm = callPackage (
    ...
    elpaBuild {
      pname = "vm";
      ename = "vm";
      version = "8.3.30.20260628.43";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/vm-8.3.30.20260628.43.tar";
        sha256 = "0zspqxd950f8wapl3gvr75k0hfzx4sqy0p5k8qywqcvwyxss5pfg";
      };
  ...
  with-editor = callPackage (
    ...
    elpaBuild {
      pname = "with-editor";
      ename = "with-editor";
      version = "3.5.1.0.20260625.4";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/with-editor-3.5.1.0.20260625.4.tar";
        sha256 = "0ddja6pzwdfa924cqfspd6d1fm0i8d3j5hxxsb42ny9pg7908sy5";
      };
      packageRequires = [
        compat
        cond-let
